...
import { Plus, Users, BookOpen, TrendingUp, Clock, Trophy } from 'lucide-react';
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-lg text-gray-600">Manage quizzes and monitor performance</p>
        </div>
        <Link
      ...
      <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/20">
        ...
        {recentAttempts.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No recent attempts</h3>
            <p className="text-gray-600">Quiz attempts will appear here once users start taking quizzes.</p>
          </div>
        ) : (
              ...
              <div key={attempt.id} className="p-6 hover:bg-gray-50 transition-colors">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{attempt.quiz_title}</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between text-sm text-gray-500">
                  ...
                  <div className={`px-2 py-1 rounded-full text-xs font-medium ${
                    ...
                    {(attempt.score / attempt.total_questions) >= 0.8 ? 'Excellent' : 
                     (attempt.score / attempt.total_questions) >= 0.6 ? 'Good' : 'Needs Improvement'}
                  </div>
                </div>
              </div>
            ))}
